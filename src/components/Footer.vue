<template>
  <footer class="footer">
    <div class="container footer-container">
      ...
      <div class="footer-links">
        ...
        <div class="footer-column">
          <h4>友情链接</h4>
          <ul>
            <li><a href="https://mc.163.com/" target="_blank">我的世界官网</a></li>
            <li><a href="https://www.minecraft.net/" target="_blank">我的世界国际服</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p>&copy; 2024 小狐狸生存服. All rights reserved.</p>
